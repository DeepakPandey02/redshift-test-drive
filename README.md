...
|04|            [Node Config](/tools/NodeConfigCompare)            | Node Configuration Comparison utility answers a very common question on which instance type and number of nodes should we choose for your workload on Amazon Redshift. Also supports datashare consumer cluster right-sizing.|[README](/tools/NodeConfigCompare/README.md)
